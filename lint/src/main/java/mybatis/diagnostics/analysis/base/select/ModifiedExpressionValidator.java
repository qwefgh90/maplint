...
public class ModifiedExpressionValidator extends ModifiedAbstractValidator<Expression> implements ExpressionVisitor {
    @Override
    ...
    public void visit(Column tableColumn) {
        validateName(tableColumn, NamedObject.column, tableColumn.getFullyQualifiedName());
    }
    ...
    private void validateOptionalExpressionList(ExpressionList expressionList) {
        if (expressionList != null) {
            expressionList.accept(getValidator(ModifiedItemsListValidator.class));
        }
    }
    ...
    public void visit(RowConstructor rowConstructor) {
        if (rowConstructor.getColumnDefinitions().isEmpty()) {
            ...
            for (ColumnDefinition columnDefinition: rowConstructor.getColumnDefinitions()) {
                validateName(rowConstructor, NamedObject.column, columnDefinition.getColumnName());
            }
        }
    }
    ...
    public void visit(NextValExpression nextVal) {
        validateName(nextVal, NamedObject.sequence, nextVal.getName());
    }
