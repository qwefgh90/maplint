...
public class ModifiedSelectValidator extends ModifiedAbstractValidator<SelectItem>
    ...
    public void visit(PlainSelect plainSelect) {
        ...
        if (plainSelect.getGroupBy() != null) {
            plainSelect.getGroupBy().accept(getValidator(ModifiedGroupByValidator.class));
        }
        ...
        if (plainSelect.getLimit() != null) {
            getValidator(ModifiedLimitValidator.class).validate(plainSelect.getLimit());
        }
    ...
    public void visit(SelectExpressionItem selectExpressionItem) {
        selectExpressionItem.getExpression().accept(getValidator(ModifiedExpressionValidator.class));
    }
    ...
    public void visit(Table table) {
        validateNameWithAlias(table, NamedObject.table, table.getFullyQualifiedName(),
        ...
        if (indexHint != null && isNotEmpty(indexHint.getIndexNames())) {
            indexHint.getIndexNames().forEach(i -> validateName(table, NamedObject.index, i));
        }
        SQLServerHints sqlServerHints = table.getSqlServerHints();
        if (sqlServerHints != null) {
            validateName(table, NamedObject.index, sqlServerHints.getIndexName());
        }
    }
    ...
    public void visit(SetOperationList setOperation) {
        ...
        if (setOperation.getLimit() != null) {
            getValidator(ModifiedLimitValidator.class).validate(setOperation.getLimit());
        }
    ...
    public void visit(ValuesStatement values) {
        getValidator(ModifiedValuesStatementValidator.class).validate(values);
    }
    ...
    /**
     * Select has been validated with StatementValidator.
     * The previous SelectValidator doesn't have a function to validate Select directly.
     * ModifiedSelectValidator supports validating Select.
     * @param select
     */
    public void validate(Select select) {
        ...
        if (select.getWithItemsList() != null) {
            select.getWithItemsList().forEach(wi -> wi.accept(this));
        }
